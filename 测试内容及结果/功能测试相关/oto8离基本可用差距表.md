...
- 部分应用标题栏和切换模式的提示显示异常：
   ...
   - prime videode的标题栏没有最小化等四个按钮（窗口拉到屏幕宽度也没有）
...
- 部分游戏应用的窗口拖拽到屏幕右下角，标题栏会显示异常
   - angry bird、sparkle、terry等
...
###### 一般
- 部分应用打开直接闪退
   - 知乎、狂野飙车8、央视影音、佳能打印、交管12123、影视大全、咪咕阅读、酷狗音乐竖屏模式打开时
