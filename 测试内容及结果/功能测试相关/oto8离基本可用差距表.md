...
- chromium浏览器：打开outlook.com后崩溃
- kindle：无法下载图书，提示请设置网络连接并重试-----------2019-07-09新增，6月10号之前的版本也有此问题，打开wifi和用vpn都没用
- autocad：无法打开文件-----------2019-07-09新增，6月10号之前的版本也有此问题，打开wifi和用vpn都没用
- gfxbench：无法连接服务器-----------2019-07-09新增，6月10号之前的版本也有此问题，打开wifi和用vpn都没用
- 狂野飙车闪退
- 央视影音打开时崩溃
...
#### 多窗口
[窗口兼容模式测试结果汇总](https://github.com/openthos/app-testing-results/blob/master/%E6%B5%8B%E8%AF%95%E5%86%85%E5%AE%B9%E5%8F%8A%E7%BB%93%E6%9E%9C/%E5%8A%9F%E8%83%BD%E6%B5%8B%E8%AF%95%E7%9B%B8%E5%85%B3/%E7%AA%97%E5%8F%A3%E5%85%BC%E5%AE%B9%E6%A8%A1%E5%BC%8F%E6%B5%8B%E8%AF%95%E7%BB%93%E6%9E%9C%E6%B1%87%E6%80%BB.md)
###### 重要
- 修改窗口模式后点取消，然后无论点标题栏哪个地方都会提示是否切换模式
- 最小化一个应用后，再通过am start -n命令重启该应用，系统界面崩溃
- 设置窗口的模式为全屏模式，之后通过am start -n 命令重启应用，启动后窗口的大小仍为之前的小窗口，，但窗口设置菜单显示为全屏模式（其它模式没有此问题）
- 部分游戏应用（比如angry bird、sparkle、terry等）的窗口拖拽到屏幕右下角，标题栏会显示异常
- 窗口戏拖拽到屏幕外会自动改变窗口大小(强制横竖屏模式也如此)
- 特定操作下窗口阴影抖动严重：将窗口调小，移到屏幕右下角，再移回来，移动鼠标时窗口阴影抖动严重
- 以手机模式启动微信之类的有强制竖屏设置的应用，再全屏窗口，之后通知中心再也无法启动-----------2019-04-12新增
- 终端多次崩溃
- sparkle游戏启动时拖拽出屏幕会崩溃
- 微信（704）在手机模式（竖屏），登录按钮被注册遮盖。手机模式（横屏）还是竖屏
- 不能登录office，看不到用户名的输入框
...
- 风格不统一，有的应用是左cancel右ok，有的是左ok右cancel。并且OK应该大写
- 用chromium打开txt文件时会有红框在屏幕周围闪动
- 部分应用全屏时点击屏幕最上方的按钮经常会被标题栏干扰
- 应用适配
   - prime videode的标题栏没有最小化等四个按钮
