...
- 多窗口：今日头条会卡在政策协议的页面，无法点击同意，也无法调整窗口大小
- 多窗口：京东的切换窗口模式弹出的提示显示不完整，无法点击确认按钮
...
- 今日头条会卡在政策协议的页面，无法点击同意，也无法调整窗口大小
- 京东切换窗口模式弹出的提示显示不完整，无法点击确认按钮
- 京东的主页面窗口外始终有一圈较宽的白边
