...
- 强制横竖屏模式下，图片等控件比例仍不适应窗口大小：
   ...
   - MS Word, Excel, PoperPoint首页右侧区域显示不全
- 应用全屏时的标题栏问题
...
- 京东、抖音在竖屏模式下，切换窗口模式弹出的提示显示不完整，无法点击确认按钮
- 微信问题：
   - 微信（705）小程序无法使用
   - 微信（705）朋友圈播完视频会卡住
   - 微信（705）全屏启动时最上方会有两行NavagationBar
...
###### 一般
- 部分应用打开直接闪退
   - 知乎、狂野飙车8、央视影音、佳能打印、交管12123、影视大全、咪咕阅读、酷狗音乐（竖屏模式打开时）、淘宝、高德地图第二次及后续打开、中国移动、朗文当代英语词典、网易有道词典、铁路12306（竖屏模式）、手机天猫、tiles hop、snap chat
- 特定操作后崩溃：
...
- 微信（704）全屏开过一次小程序后，手机模式上方小程序区域显示异常，无法恢复-----------刘 2019-7-18测试通过
