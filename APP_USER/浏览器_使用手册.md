...
## Firefox 功能点
  ...
  - 10 支持网页视频播放功能
  - 11 支持双击页面顶部缩小功能
    ![](https://github.com/openthos/app-testing-results/blob/master/IMGview/browser_page_narrow.png)
  - 12 支持网页新开窗口功能
  - 13 支持网页版百度云盘存取数据功能
  - 14 支持网页音乐播放功能
  - 15 支持网页应用下载功能
  ...
  - 29 支持编辑框提示信息
  - 30 支持编辑框搜索历史记录
    ！[](https://github.com/openthos/app-testing-results/blob/master/IMGview/tmp_15694-browsre_search_history-582257663.png)
  - 31 支持天气查看功能
  - 32 支持图片上传功能
  - 33 支持图片下载
  - 34 支持图片分享功能
