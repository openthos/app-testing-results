...
- 连接有线网络：不可用(已备份过，恢复数据时没有变化，桌面壁纸尺寸显示错误)
- 连接无线网络：不可用(已备份过，恢复数据时没有变化，桌面壁纸尺寸显示错误)
- 未连接网络：不可用(已备份过，恢复数据时没有变化，桌面壁纸尺寸显示错误)
...
### 问题汇总：
 ...
 - bug 2295 云服务：本地云服务拷贝apk文件，网页端刷新后不显示（大概隔了20分钟，才显示出来）
